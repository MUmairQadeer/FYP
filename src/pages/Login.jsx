      ...
      >
        ...
        <div className="glass-card p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-dark-400 text-sm mt-1">Sign in to continue planning your trips</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link to="/forgot-password" className="text-primary-400 hover:text-primary-300 no-underline transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-dark-800/80 text-dark-500 text-sm">or</span>
            </div>
          </div>

          {/* Google OAuth */}
          <button className="w-full py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-dark-200 font-medium text-sm flex items-center justify-center gap-3 hover:bg-white/[0.08] hover:border-white/[0.12] transition-all cursor-pointer">
